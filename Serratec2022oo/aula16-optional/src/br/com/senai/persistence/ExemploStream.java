...
public class ExemploStream {
	...
	public static void main(String[] args) {
		...
		boolean achou = funcionarios.stream().anyMatch(f -> f.getSetor().equals("DP"));
		//System.out.println(achou);
		
		List<String> nomes = funcionarios.stream().sorted(Comparator.comparing(Funcionario::getNome).reversed()).map(Funcionario::getNome).collect(Collectors.toList());
