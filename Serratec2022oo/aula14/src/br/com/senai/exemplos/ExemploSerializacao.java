...
public class ExemploSerializacao {
	...
	public static void main(String[] args) {
		...
		try {
			FileInputStream caminhoArquivo = new FileInputStream("exemplos1/fornecedor.dat");// Formato "dat" é usado
																								// para arquivos
																								// binários
