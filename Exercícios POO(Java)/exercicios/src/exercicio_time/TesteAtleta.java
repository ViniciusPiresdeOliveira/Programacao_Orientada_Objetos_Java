...
public class TesteAtleta {
	...
	public static void main(String[] args) {
		...
		listaAtletas.add(new Atleta("Fábio", 41, "Goleiro"));
		...
		listaAtletas.add(new Atleta("André", 20, "1º volante"));
		listaAtletas.add(new Atleta("Yago", 27, "2º volante"));
		listaAtletas.add(new Atleta("Ganso", 32, "Meia"));
		listaAtletas.add(new Atleta("Árias", 24, "Segundo Atacante"));
		listaAtletas.add(new Atleta("Cano", 34, "Atacante"));
		
		Time time1 = new Time("Fluminense", "Abel Braga", "Paulo Angioni", listaAtletas, "Mário Bittencourt", "Marcão");
