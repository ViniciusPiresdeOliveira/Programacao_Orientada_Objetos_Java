...
public class Lutador {
	...
	private void setCategoria() {
		if (this.peso < 52.2) {
			this.categoria = "Inválido. Pois o lutador está abaixo peso";
			...
			this.categoria = "Inválido. Pois o lutador está acima do peso";
		}
	}
	...
	public void apresentar() {
        ...
        if (aux.substring(aux.length() - 1, aux.length()).equals("a")  && !aux.substring(aux.length() - 1, aux.length()).equals("Canadá")) {
		...
		if (this.getVitorias() == 0 || this.getVitorias() == 1) {
			System.out.println(this.vitorias + " vitória");
		} else{
